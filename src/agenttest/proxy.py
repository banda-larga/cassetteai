...
from agenttest.cassette import Cassette, CassetteEntry, _hash_request

if TYPE_CHECKING:
    from agenttest.mock_tools import MockToolRegistry
...
class Proxy:
    ...
    async def _replay(
        ...
        if entry is None:
            from agenttest.cassette import _hash_request
